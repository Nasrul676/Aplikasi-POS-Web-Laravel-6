...
class DashboardController extends Controller
{
    ...
    {
        $laris = DB::select('SELECT nama_barang, SUM(qty) qty,  SUM(harga) harga FROM history_transactions GROUP BY nama_barang ORDER BY qty DESC LIMIT 10');
        $laris_nama_barang = RiwayatTransaksiModel::all();
